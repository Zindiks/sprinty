...
export class ConflictError extends ApiError {
  constructor(message: string = "Resource conflict", details?: any) {
    super(message, HttpStatus.CONFLICT, ErrorCodes.RESOURCE_CONFLICT, true, details);
...
export class DuplicateResourceError extends ApiError {
  constructor(message: string = "Resource already exists", details?: any) {
    super(message, HttpStatus.CONFLICT, ErrorCodes.DUPLICATE_RESOURCE, true, details);
...
export class UsernameAlreadyExistsError extends ApiError {
  constructor(message: string = "Username already exists", details?: any) {
    super(message, HttpStatus.CONFLICT, ErrorCodes.USERNAME_ALREADY_EXISTS, true, details);
...
export class EmailAlreadyExistsError extends ApiError {
  constructor(message: string = "Email already exists", details?: any) {
    super(message, HttpStatus.CONFLICT, ErrorCodes.EMAIL_ALREADY_EXISTS, true, details);
