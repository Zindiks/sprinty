...
export class AuthenticationError extends ApiError {
  constructor(message: string = "Authentication failed", details?: any) {
    super(message, HttpStatus.UNAUTHORIZED, ErrorCodes.AUTHENTICATION_FAILED, true, details);
...
export class InvalidCredentialsError extends ApiError {
  constructor(message: string = "Invalid credentials", details?: any) {
    super(message, HttpStatus.UNAUTHORIZED, ErrorCodes.INVALID_CREDENTIALS, true, details);
...
export class TokenExpiredError extends ApiError {
  constructor(message: string = "Token has expired", details?: any) {
    super(message, HttpStatus.UNAUTHORIZED, ErrorCodes.TOKEN_EXPIRED, true, details);
...
export class InvalidTokenError extends ApiError {
  constructor(message: string = "Invalid token", details?: any) {
    super(message, HttpStatus.UNAUTHORIZED, ErrorCodes.TOKEN_INVALID, true, details);
